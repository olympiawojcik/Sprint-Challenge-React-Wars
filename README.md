...
- [ ] You must have at least one list element for each star wars character in the data set (Name, and then one list element for each star wars character in the data set)
